            ...
            layui.use(['laypage', 'layer', 'table'], function(){
                ...
                table.render({
                    ...
                    ,cols: [[
                        ...
                        ,{field:'cinema_name', title:'影院名称', width:300, unresize: true,sort: true, edit: "text"}
                        ,{field:'cinema_address', title:'影院地址', width:500, unresize: true,sort: true, edit: "text"}
                ...
                table.on('tool(CinemaTable)', function(obj){
                    var data = obj.data;
                    if(obj.event === 'detail'){
                        layer.msg('影院ID：'+ data.cinema_id + '</br>影院名称：'+ data.cinema_name + '</br>影院地址：'+ data.cinema_address);
                    }
                    if(obj.event === 'edit'){
                    ...
                    switch(obj.event){
                        case 'cinemaadd':
                            ...
                            table.reload('cinema_table_id', {
                                url: url + '/cinema/findCinemasLikeName'
                                ,method: "POST"
                                ,where: {
                                    cinema_name: cinema_name
                                }
            ...
            $.ajax({
                ...
                success:function (obj) {
                    ...
                    option1 = {
                        ...
                        color: ['#4545ab', '#b6a2de', '#2bb6aa', '#9AC0CD','#ff99cc'],
                        legend: {
                            orient : 'vertical',
                            x : '10%',
                            y : '15%',
