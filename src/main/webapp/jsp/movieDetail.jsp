        ...
        function initBanner(){
            ...
            $.ajax({
                ...
                success:function (obj) {
                    ...
                    actionBuyBtn.append("<a class=\"btn buy\" href=\"./buyTickets.jsp?movie_id=" + movie_id + "\" data-act=\"more-detail-click\">特惠购票</a>");
                            ...
                            "<div class=\"celebrity-group\">" +
                                ...
                                "<ul class=\"celebrity-list clearfix\">" +
                                    "<li class=\"celebrity\">" +
                                        ...
                                        "</a>" +
                                        "<div>" +
                                            "<a style=\"text-decoration: none;\" class=\"name\">" + StrRole[0] +"<br>"+ "饰&nbsp" + StrRole[1] + "</a>" +
                                        "</div>" +
                                    "</li>" +
                                "</ul>" +
                            "</div>"
