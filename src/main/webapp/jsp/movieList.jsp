    ...
    <script>
        ...
        function initMovieList(){
            if(getUrlParams("type") == "全部" || getUrlParams("type") == null){
                $.ajax({
                    ...
                    data: {order: order,type:type,area:area,year:year,searchMovie:searchMovie},
                    dataType: "json",
        ...
        function initTags(){
            var tagsType = $(".tags-type"),
                tagsArea = $(".tags-area"),
                tagsYear = $(".tags-year");
            var TypeStr = ["全部","爱情","喜剧","动画","剧情","惊悚","科幻","动作","悬疑","犯罪","战争","历史","青春","冒险","运动","家庭","古装","纪录片","灾难","儿童","其他"],
                AreaStr = ["全部","中国大陆","美国","韩国","日本","中国香港","中国台湾","泰国","印度","法国","英国","俄罗斯","意大利"],
                YearStr = ["全部","2022","2021","2019","2018","2017","2016","2015","2014"];
            var TypeActive = [],
                AreaActive = [],
                YearActive = [];
